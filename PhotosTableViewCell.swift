...
class PhotosTableViewCell: UITableViewCell {
    ...
    private lazy var arrowView: UIImageView = {
        let arrow = UIImage(systemName: "arrow.right.square")?.withTintColor(.black, renderingMode: .alwaysOriginal)
    ...
    private func setupView() {
        ...
        NSLayoutConstraint.activate([
                ...
                arrowView.trailingAnchor.constraint(equalTo: backView.trailingAnchor, constant: -12.0),
                arrowView.centerYAnchor.constraint(equalTo: collectionLabel.centerYAnchor),
                arrowView.heightAnchor.constraint(equalTo: collectionLabel.heightAnchor),
